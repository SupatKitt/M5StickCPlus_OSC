...
int port = 9002; // port number on your device
//=============================================
...
float DistanceValidation(uint16_t distance){
  ...
  if(distance > 600.0f) // set at 600 because the sensor cone is narrow so it would feel stuttering and less responsive if runnning at maximum range
